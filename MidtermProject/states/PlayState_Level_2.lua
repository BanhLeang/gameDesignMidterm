PlayState_Level_2 = Class{__includes = BaseState}
...
function PlayState_Level_2:init()
    self.bird = Bird()
...
function PlayState_Level_2:update(dt)
...
function PlayState_Level_2:render()
    ...
    love.graphics.print('NOW IN LEVEL-2' , 8, 8)
...
function PlayState_Level_2:enter(params)
...
function PlayState_Level_2:exit()
